...
import static epos.slm3d.io.BinOutputStream.doubleToQ31;
...
//              System.out.println("Addr="+xx.addr +", Code="+xx.code);
    ...
    try{
       int coordX=doubleToQ31(Double.parseDouble(guideX.getText()));
       int coordY=doubleToQ31(Double.parseDouble(guideY.getText()));
