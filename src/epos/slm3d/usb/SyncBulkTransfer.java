...
public class SyncBulkTransfer
{
    ...
    /** The vendor ID of the Samsung Galaxy Nexus. ФЛЭШКА*/
    private static final short VENDOR_ID = 0x0518;

    /** The vendor ID of the Samsung Galaxy Nexus.  ФЛЭШКА*/
    private static final short PRODUCT_ID = (short)0x01;
    ...
    public static void write(DeviceHandle handle, byte[] data)
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DeviceHandle handle = LibUsb.openDeviceWithVidPid(ctx, VENDOR_ID,
            PRODUCT_ID);
        if (handle == null)
        {
